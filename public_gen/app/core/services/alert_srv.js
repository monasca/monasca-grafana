        ...
        execute: function () {///<reference path="../../headers/common.d.ts" />
            AlertSrv = (function () {
                ...
                AlertSrv.prototype.init = function () {
                    ...
                    app_events_1.default.on('alert-warning', function (options) { return _this.set(options[0], options[1], 'warning', 5000); });
                    app_events_1.default.on('alert-success', function (options) { return _this.set(options[0], options[1], 'success', 3000); });
                    app_events_1.default.on('alert-error', function (options) { return _this.set(options[0], options[1], 'error', 7000); });
